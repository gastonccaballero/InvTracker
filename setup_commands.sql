-- InvTracker Database Setup Commands
-- Run these commands in your PostgreSQL client

-- 1. Create the database (run this first)
CREATE DATABASE invtracker;

-- 2. Connect to the database (run this after creating it)
-- In psql: \c invtracker;
-- In other clients: connect to the 'invtracker' database

-- 3. Create all tables and setup the schema
...
-- 10. View all tables (run this to verify)
